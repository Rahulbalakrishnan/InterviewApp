...
This repository contains a Native Android app developed as part of an internship process for Listed Inc. OpenInApp. 
The assignment involves creating the app from scratch based on a UI design provided as a Figma file.
